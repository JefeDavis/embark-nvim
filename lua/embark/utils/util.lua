local hsluv = require("embark.utils.hsluv")
...
function util.terminal(cp)
	g.terminal_color_0 = cp.space4
	g.terminal_color_8 = cp.space1

	g.terminal_color_1 = cp.red
	g.terminal_color_9 = cp.darkRed

	g.terminal_color_2 = cp.green
	g.terminal_color_10 = cp.darkGreen

	g.terminal_color_3 = cp.yellow
	g.terminal_color_11 = cp.darkYellow

	g.terminal_color_4 = cp.blue
	g.terminal_color_12 = cp.darkBlue

	g.terminal_color_5 = cp.magenta
	g.terminal_color_13 = cp.darkMagenta

	g.terminal_color_6 = cp.cyan
	g.terminal_color_14 = cp.darkCyan

	g.terminal_color_7 = cp.astral1
	g.terminal_color_15 = cp.astral0
end
...
function util.load(theme)
	...
	if require("embark.config").options["term_colors"] then
